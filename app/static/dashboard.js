...
function renderHelpTab() {
  ...
  <div data-hsec id="hs-strategies" style="display:none">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-bottom:12px">
      ${[
        ["0 — Норма","Пн–Чт, завтра рабочий день. SHORT разрешён.","#2fa36b"],
        ["1 — Риск","Завтра нерабочий день (праздник). SHORT заблокирован.","#f0c04a"],
        ["3 — Высокий риск","Пятница или длинные выходные (3+ дней). SHORT заблокирован.","#ff7b7b"],
